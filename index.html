    ...
    <section class="section categories">
      <div class="container">
        ...
        <div class="category-grid">
          <a class="category-card reveal" href="#catalog" data-category-jump="adult"><img src="assets/customers/customer-02.webp" alt="Взрослые велосипеды"><div class="category-overlay"></div><div><small>26 • 27,5 • 29 колёса</small><h3>Взрослые</h3><span>Смотреть модели →</span></div></a>
          <a class="category-card reveal" href="#catalog" data-category-jump="teen"><img src="assets/customers/customer-11.webp" alt="Подростковые велосипеды"><div class="category-overlay"></div><div><small>20 • 24 • 26 колёса</small><h3>Подростковые</h3><span>Смотреть модели →</span></div></a>
          <a class="category-card reveal" href="#catalog" data-category-jump="child"><img src="assets/customers/customer-19.webp" alt="Детские велосипеды"><div class="category-overlay"></div><div><small>12 • 14 • 16 • 18 колёса</small><h3>Детские</h3><span>Смотреть модели →</span></div></a>
          <a class="category-card reveal" href="#catalog" data-category-jump="scooter"><img src="assets/photo-6.jpg" alt="Электросамокаты"><div class="category-overlay"></div><div><small>Для города и прогулок</small><h3>Электросамокаты</h3><span>Смотреть модели →</span></div></a>
        </div>
      </div>
    </section>
    ...
    <section class="section recent-sales" id="recent-sales">
      <div class="container">
        ...
        <div class="sales-strip reveal">
          <article><img src="assets/customers/customer-01.webp" alt="Покупатель с велосипедом 26 дюймов"><div><span>Сегодня</span><h3>Алюминиевый велосипед 26”</h3><p>Гидравлические тормоза</p></div></article>
          <article><img src="assets/customers/customer-09.webp" alt="Покупатель с BMX"><div><span>Недавно</span><h3>Яркий BMX</h3><p>Для трюков и активного катания</p></div></article>
          <article><img src="assets/customers/customer-19.webp" alt="Девочка с детским велосипедом"><div><span>Недавно</span><h3>Детский велосипед</h3><p>Подобран по росту</p></div></article>
        </div>
      </div>
    </section>
